...
class DnacNetwork(DnacBase):
    ...
    def requires_update(self, have, want, obj_params):
        ...
        current_obj = have
        requested_obj = want
        self.log("Current State (have): " + str(current_obj), "DEBUG")
        self.log("Desired State (want): " + str(requested_obj), "DEBUG")
    ...
    def get_obj_params(self, get_object):
        ...
        try:
            ...
            self.log("Error message:" + msg, "CRITICAL")
    ...
    def get_site_id(self, site_name):
        ...
        try:
            ...
            self.log("Site ID: " + str(_id), "DEBUG")
        except Exception as msg:
            self.log("Error while getting site_id from the site_name: " + msg, "CRITICAL")
            return None
    ...
    def get_global_pool_params(self, pool_info):
        ...
        self.log("Global Pool Information: " + str(pool_info), "DEBUG")
        global_pool = {
            "settings": {
                "ippool": [{
        ...
        self.log("Formated Global Pool Information: " + str(global_pool), "DEBUG")
        ...
        self.log("IpAddressSpace: " + str(global_ippool.get("IpAddressSpace")), "DEBUG")
    ...
    def get_reserve_pool_params(self, pool_info):
        ...
        self.log("Formatted Reserve Pool Information: " + str(reserve_pool), "DEBUG")
        return reserve_pool
    ...
    def get_network_params(self, site_id):
        ...
        self.log("Response from API get_network_v2: " + str(response), "DEBUG")
        if not isinstance(response, dict):
            self.log("Error in getting network details - Response is not a dictionary", "ERROR")
            return None
        ...
        self.log("Formatted playbook network details: " + str(network_details), "DEBUG")
    ...
    def global_pool_exists(self, name):
        ...
        if not isinstance(response, dict):
            self.log("Error in getting global pool - Response is not a dictionary", "CRITICAL")
            return global_pool

        all_global_pool_details = response.get("response")
        global_pool_details = get_dict_result(all_global_pool_details, "ipPoolName", name)
        self.log("Global Ippool Name: " + str(name), "DEBUG")
        self.log("Global Pool Details: " + str(global_pool_details), "DEBUG")
        ...
        self.log("Formatted Global Pool Details:" + str(global_pool), "DEBUG")
        return global_pool
    ...
    def reserve_pool_exists(self, name, site_name):
        ...
        self.log("Site ID: " + str(site_id), "DEBUG")
        if not site_id:
        ...
        if not reserve_pool_details:
            self.log("Reserve pool {0} does not exist in the site {1}"
        ...
        self.log("Reserved Pool Details: " + str(reserve_pool.get("details")), "DEBUG")
        self.log("Reserved Pool Id: " + str(reserve_pool.get("id")), "DEBUG")
        return reserve_pool
    ...
    def get_have_global_pool(self, config):
        ...
        self.log("Global Pool Details: " + str(global_pool), "DEBUG")
        ...
        self.log("pool Exists: " + str(global_pool.get("exists")) +
                 "\n Current Site: " + str(global_pool.get("details")), "DEBUG")
    ...
    def get_have_reserve_pool(self, config):
        ...
        self.log("Site Name: " + str(site_name), "DEBUG")
        ...
        self.log("Reserve Pool Details: " + str(reserve_pool), "DEBUG")
        ...
        self.log("Reservation Exists: " + str(reserve_pool.get("exists")) +
                 "\n Reserved Pool: " + str(reserve_pool.get("details")), "DEBUG")
    ...
    def get_have_network(self, config):
        ...
        self.log("Network Details from the Cisco DNA Center: " + str(network), "DEBUG")
    ...
    def get_want_global_pool(self, global_ippool):
        ...
        self.log("Global Pool Playbook Details: " + str(want_global), "DEBUG")
    ...
    def get_want_reserve_pool(self, reserve_pool):
        ...
        self.log("Reserve IP Pool Playbook Details: " + str(want_reserve), "DEBUG")
    ...
    def get_want_network(self, network_management_details):
        ...
        self.log("DNAC Details: " + str(self.have), "DEBUG")
        ...
        self.log("Network Playbook Details: " + str(want_network), "DEBUG")
    ...
    def update_global_pool(self, config):
        ...
        if not self.have.get("globalPool").get("exists"):
            ...
            self.log("Playbook Global Pool Details: " + str(pool_params), "DEBUG")
            response = self.dnac._exec(
                family="network_settings",
            ...
            self.log("Global Pool Created Successfully", "INFO")
        ...
        if not self.requires_update(self.have.get("globalPool").get("details"),
            ...
            self.log("Global pool doesn't requires an update", "INFO")
            ...
            self.log("Result: " + str(self.result), "DEBUG")
            return

        self.log("Pool requires update", "DEBUG")
        # Pool Exists
        ...
        self.check_execution_response_status(response).check_return_status()
        self.log("Global Pool Updated Successfully", "INFO")
        result_global_pool.get("response").get(name) \
    ...
    def update_reserve_pool(self, config):
        ...
        self.log("Reserve Pool Cisco DNA Center Details: " +
                 str(self.have.get("reservePool").get("details")), "DEBUG")
        self.log("Reserve Pool User Details: " +
                 str(self.want.get("wantReserve")), "DEBUG")

        # Check pool exist, if not create and return
        self.log(str(self.want.get("wantReserve").get("ipv4GlobalPool")), "DEBUG")
        ...
        if not self.have.get("reservePool").get("exists"):
            self.log("Reserve Pool Playbook Details: " + str(reserve_params), "DEBUG")
            response = self.dnac._exec(
                family="network_settings",
            ...
            self.check_execution_response_status(response).check_return_status()
            self.log("Ip Subpool Reservation Created Successfully", "INFO")
        ...
        if not self.requires_update(self.have.get("reservePool").get("details"),
            ...
            self.log("Reserved ip subpool doesn't require an update", "INFO")
            result_reserve_pool.get("response").get(name) \
        ...
        self.log("Reserve ip pool requires an update", "DEBUG")
        # Pool Exists
        self.log("Reserved Ip Pool Cisco DNA Center Details: " +
                 str(self.have.get("reservePool")), "DEBUG")
        self.log("Reserved Ip Pool User Details: " + str(self.want.get("wantReserve")), "DEBUG")
    ...
    def update_network(self, config):
        ...
        if not self.requires_update(self.have.get("network").get("net_details"),
            ...
            self.log("Network doesn't require an update", "INFO")
        ...
        self.log("Network requires update", "INFO")
        self.log("Network Cisco DNA Center Details: " + str(self.have.get("network")), "DEBUG")
        self.log("Network User Details: " + str(self.want.get("wantNetwork")), "DEBUG")
        ...
        self.log("Response of API update_network_v2: " + str(response), "DEBUG")
    ...
    def delete_reserve_pool(self, name):
        ...
        self.log("Reserved Ip Pool to be deleted: " +
                 str(self.have.get("reservePool").get("name")), "INFO")
        _id = self.have.get("reservePool").get("id")
        self.log("Reserve pool {0} id ".format(name) + str(_id), "DEBUG")
        response = self.dnac._exec(
            family="network_settings",
    ...
    def verify_diff_merged(self, config):
        ...
        self.log("Current State (have): " + str(self.have), "INFO")
        self.log("Requested State (want): " + str(self.want), "INFO")
        if config.get("global_pool_details") is not None:
            self.log(str(self.want.get("wantGlobal")), "DEBUG")
            self.log(str(self.have.get("globalPool").get("details")), "DEBUG")
            ...
            self.log("Successfully validated Global Pool", "INFO")
        ...
        if config.get("reserve_pool_details") is not None:
            if self.requires_update(self.have.get("reservePool").get("details"),
                                    self.want.get("wantReserve"), self.reserve_pool_obj_params):
                self.log(str(self.want.get("wantReserve")), "DEBUG")
                self.log(str(self.have.get("reservePool").get("details")), "DEBUG")
                self.msg = "Reserve Pool Config is not applied to the DNAC"
                self.status = "failed"
                return self

            self.log("Successfully validated the Reserve Pool", "INFO")
        ...
        if config.get("network_management_details") is not None:
            ...
            self.log("Successfully validated the Network Functions", "INFO")
    ...
    def verify_diff_deleted(self, config):
        ...
        if config.get("global_pool_details") is not None:
            ...
            self.log("Successfully validated absence of Global Pool", "INFO")
            self.result.get("response")[0].get("globalPool").update({"Validation": "Success"})
        ...
        if config.get("reserve_pool_details") is not None:
            ...
            self.log("Successfully validated the absence of Reserve Pool", "INFO")
            self.result.get("response")[1].get("reservePool").update({"Validation": "Success"})
